			...
			<div className="px-4">
				<div className="flex items-center mt-4 space-x-3">
					...
					<div className="flex flex-col">
						...
						<Link className="text-sm text-gray-700" href="/profile/edit">Edit profile &rarr;</Link>
					</div>
				</div>
				...
				<div className="mt-12">
					<div className="flex space-x-4 items-center">
						...
						<div>
							<h4 className="text-sm font-bold text-gray-800">로셍</h4>
